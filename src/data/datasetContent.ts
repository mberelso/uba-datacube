...
DF_CLIMATE_GERMANY_TEMPERATURE_MEAN: {
  ...
  DF_ENERGY_AGEE_CAPACITY: {
    headline: 'Deutschlands Ökostrom-Kapazität hat sich seit 1990 verfünfzigfacht.',
    ...
    trend: 'Die installierte Kapazität erneuerbarer Energien ist in den vergangenen drei Jahrzehnten nahezu ununterbrochen gewachsen, angetrieben vor allem durch den massiven Ausbau von Photovoltaik und Windkraft an Land. Allein im letzten Jahrzehnt hat sich die Gesamtkapazität mehr als verdoppelt, wobei Solaranlagen inzwischen den größten Einzelanteil stellen.',
    context: 'Das Erneuerbare-Energien-Gesetz schreibt vor, dass bis 2030 mindestens 80 Prozent des deutschen Stroms aus erneuerbaren Quellen stammen sollen – diese Kapazitätsdaten zeigen, ob der Ausbau schnell genug läuft, um dieses Ziel zu erreichen. Bundesministerien, die EU-Kommission und internationale Klimaberichterstattung stützen sich direkt auf diese Zahlen.',
    methodology: 'Gemessen wird die installierte elektrische Nennleistung in Megawatt – also das theoretische Maximum, nicht die tatsächlich erzeugte Strommenge. Die Daten erfassen keine Auslastung oder Wetterbedingungen, weshalb hohe Kapazität nicht automatisch hohe Stromproduktion bedeutet.',
    status: 'draft',
  },

  // AUTO-GENERATED DRAFT — please review and set status to 'reviewed'
  DF_ENERGY_AGEE_ECONOMY: {
    headline: 'Erneuerbare Energien pumpen jährlich Milliarden in die deutsche Wirtschaft.',
    ...
    trend: 'Seit 2000 steigen sowohl die Investitionen in neue Anlagen als auch die wirtschaftlichen Effekte aus dem Betrieb bestehender Anlagen insgesamt an, wobei einzelne Jahre je nach Förderpolitik und Ausbaumengen stark schwanken. Der Ausbau der Windkraft an Land und auf See sowie der Photovoltaik treibt dabei den größten Teil des Wachstums.',
    context: 'Die Bundesregierung ist gesetzlich verpflichtet, den Anteil erneuerbarer Energien am Stromverbrauch bis 2030 auf 80 Prozent zu steigern — Investitions- und Wirtschaftsdaten aus diesem Datensatz fließen direkt in nationale und EU-weite Berichte ein. Politikerinnen und Politiker nutzen diese Zahlen, um Förderprogramme zu rechtfertigen oder anzupassen.',
    methodology: 'Gemessen werden Investitionen in den Neubau von Anlagen sowie Umsatz- und Beschäftigungseffekte aus dem Betrieb bestehender Anlagen, aufgeschlüsselt nach Energieträgern. Die Daten beruhen auf Schätzungen und Modellrechnungen der AGEE-Stat und werden zweimal jährlich aktualisiert, sodass aktuelle Jahreswerte vorläufig sein können.',
    status: 'draft',
  },

  // AUTO-GENERATED DRAFT — please review and set status to 'reviewed'
  DF_ENERGY_AGEE_ELECTRICITY: {
    headline: 'Erneuerbare Energien decken heute mehr als die Hälfte des deutschen Stroms.',
    lead: 'Dieser Datensatz zeigt, wie viel Strom Deutschland seit 1990 aus Wind, Sonne, Wasser und Biomasse erzeugt hat – aufgeschlüsselt nach Quelle und Jahr. Wer verstehen will, ob die Energiewende vorankommt oder stockt, findet hier die Grundlage.',
    trend: 'Der Anteil erneuerbarer Energien an der Stromerzeugung ist seit 1990 kontinuierlich gestiegen und hat zuletzt die 50-Prozent-Marke überschritten. Windkraft – sowohl an Land als auch auf See – liefert dabei den größten Beitrag und hat Kohle als wichtigste Stromquelle abgelöst. Der Zubau bei Photovoltaik beschleunigt sich seit 2022 spürbar.',
    context: 'Die Daten bilden die Grundlage für Deutschlands Berichtspflichten gegenüber der EU und belegen, ob das Ziel von 80 Prozent erneuerbarem Strom bis 2030 erreichbar ist. Politische Entscheidungen über Ausschreibungsmengen, Netzausbau und den Kohleausstieg stützen sich direkt auf diese Zahlen. Auch die EU-Erneuerbaren-Richtlinie (RED III) verlangt regelmäßige, harmonisierte Nachweise dieser Art.',
    methodology: 'Gemessen wird die Bruttostromerzeugung aus erneuerbaren Quellen in Gigawattstunden, ergänzt um die Nettostromerzeugung, die den Eigenverbrauch der Kraftwerke herausrechnet. Die Daten beruhen auf Schätzungen und Hochrechnungen verschiedener Bundesbehörden und werden zweimal jährlich aktualisiert, sodass aktuelle Jahreswerte noch vorläufig sein können.',
    status: 'draft',
  },

  // AUTO-GENERATED DRAFT — please review and set status to 'reviewed'
  DF_ENERGY_AGEE_HEAT: {
    headline: 'Erneuerbare Wärme wächst, deckt aber erst ein Fünftel des deutschen Bedarfs.',
    ...
    trend: 'Der Anteil erneuerbarer Energien am Wärmeverbrauch steigt seit Jahren kontinuierlich, doch das Tempo reicht kaum aus: Von 1990 bis heute hat sich der Beitrag zwar mehr als verdreifacht, stagniert aber zuletzt bei rund 17 bis 18 Prozent des gesamten Wärme- und Kältebedarfs. Biomasse trägt dabei den weitaus größten Teil, während Wärmepumpen und Solarthermie schnell wachsen, aber noch kleine Anteile halten.',
    ...
    methodology: 'Gemessen wird der tatsächliche Endenergieverbrauch aus erneuerbaren Quellen für Raumwärme, Warmwasser und Kälte in Deutschland, aufgeschlüsselt nach Energieträgern. Die Daten beruhen auf Schätzungen und Hochrechnungen von AGEE-Stat und werden zweimal jährlich aktualisiert, was bedeutet, dass aktuelle Jahreswerte zunächst vorläufig sind.',
    status: 'draft',
  },

  // AUTO-GENERATED DRAFT — please review and set status to 'reviewed'
  DF_ENERGY_AGEE_HEAT_PUMP_STAT: {
    headline: 'Wärmepumpen heizen Deutschland – die Zahlen zeigen, wie schnell.',
    ...
    trend: 'Seit 2003 steigt die Zahl der installierten Wärmepumpen in Deutschland kontinuierlich – in den letzten Jahren beschleunigte sich dieser Anstieg spürbar, getrieben durch steigende Gaspreise und den politischen Druck, fossile Heizungen zu ersetzen. Die nutzbare erneuerbare Wärme aus Wärmepumpen wächst dabei überproportional, weil neuere Geräte effizienter arbeiten als ältere Modelle.',
    context: 'Die Bundesregierung hat das Ziel ausgegeben, ab 2024 jährlich 500.000 neue Wärmepumpen zu installieren – ein Ziel, das bislang verfehlt wurde. Das Gebäudeenergiegesetz verpflichtet Haushalte schrittweise zum Umstieg auf erneuerbare Heizungen, und die EU-Erneuerbare-Energien-Richtlinie schreibt Deutschland verbindliche Quoten vor, zu deren Berechnung diese Daten direkt beitragen.',
    methodology: 'Gemessen werden Anzahl, thermische Leistung, Endenergieverbrauch und nutzbare erneuerbare Wärme verschiedener Wärmepumpentypen – aufgeteilt nach Wärmequelle wie Luft, Erde oder Wasser. Die Daten beruhen auf Schätzungen und Hochrechnungen der AGEE-Stat und bilden nicht jeden einzelnen Einbau ab, sondern aggregierte nationale Trends.',
    status: 'draft',
  },
